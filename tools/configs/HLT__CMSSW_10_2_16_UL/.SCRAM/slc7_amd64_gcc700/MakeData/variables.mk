...
CMSSW_BASE:=/afs/crc.nd.edu/user/g/gziemyt2/Public/MCsampleProductions/FullSimulation/Spring2024/RunIISummer20UL18/HLT__CMSSW_10_2_16_UL
...
LHAPDF_BASE:=/cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/lhapdf/6.2.1-gnimlf3
...
export CCACHE_BASEDIR:=/afs/crc.nd.edu/user/a/atownse2/Public/KKTriPhoton/SignalGEN/condor/RunIISummer20UL18/HLT__CMSSW_10_2_16_UL
endif
...
MADGRAPH5AMCATNLO_BASE:=/cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/madgraph5amcatnlo/2.6.0-gnimlf9
...
PYTHIA8_BASE:=/cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/pythia8/230-gnimlf5
...
VINCIA_BASE:=/cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/vincia/2.2.01-gnimlf5
...
JIMMY_BASE:=/cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/jimmy/4.2-gnimlf3
DIRE_BASE:=/cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/dire/2.002-gnimlf
...
CHARYBDIS_BASE:=/cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/charybdis/1.003-gnimlf3
...
HERWIG_BASE:=/cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/herwig/6.521-gnimlf3
...
OPENLOOPS_BASE:=/cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/openloops/2.0.0-gnimlf
DCAP_BASE:=/cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/dcap/2.47.8-omkpbe2
JIMMY_HEADERS_BASE:=/cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/jimmy/4.2-gnimlf3
...
CASCADE_BASE:=/cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/cascade/2.2.04-gnimlf3
...
SHERPA_BASE:=/cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/sherpa/2.2.6-gnimlf2
...
THEPEG_BASE:=/cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/thepeg/2.1.4-gnimlf2
...
CASCADE_HEADERS_BASE:=/cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/cascade/2.2.04-gnimlf3
ifeq ($(strip $(SCRAM_COMPILER)),distcc)
...
HERWIGPP_BASE:=/cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/herwigpp/7.1.4-gnimlf3
...
TAUOLAPP_BASE:=/cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/tauolapp/1.1.5-gnimlf5
...
EVTGEN_BASE:=/cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/evtgen/1.6.0-gnimlf5
...
LOCALTOP:=/afs/crc.nd.edu/user/g/gziemyt2/Public/MCsampleProductions/FullSimulation/Spring2024/RunIISummer20UL18/HLT__CMSSW_10_2_16_UL
SCRAM_TMP:=tmp
SCRAM_INIT_LOCALTOP:=/afs/crc.nd.edu/user/a/atownse2/Public/RSTriPhoton/preprocessing/tools/EXO-MCsampleProductions/FullSimulation/RunIISummer20UL18/HLT__CMSSW_10_2_16_UL
SCRAM_BUILDFILE:=BuildFile
RELEASETOP:=/cvmfs/cms.cern.ch/slc7_amd64_gcc700/cms/cmssw/CMSSW_10_2_16_UL
SCRAM_INTlog:=logs
...
SCRAM_SOURCEDIR:=src
SCRAM_RTBOURNE_SET:=CMSSW:CMSSW_10_2_16_UL:slc7_amd64_gcc700:V2_2_9_pre20:SRT_
SCRAM_CONFIGCHKSUM:=V05-07-32
SCRAM_RUNTIME_TYPE:=BUILD
SCRAM_LOOKUPDB_WRITE:=/cvmfs/cms.cern.ch
SCRAM_CXX11_ABI:=1
SCRAM_PROJECTVERSION:=CMSSW_10_2_16_UL
